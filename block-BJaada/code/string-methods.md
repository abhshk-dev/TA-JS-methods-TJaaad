...
13. `padStart`
   ...
   - Example:
     ...
     console.log(middleName.indexOf(6,"@"));//"Gopal@"
     ```
   - The padStart() method adds padding to the starting of the string.
14. `repeat`
   - Parameter: count(number data type) it specifies the number of times the user wants the string to be repeated 
   - Return: Returns string.
   - Example:
     ```js
     const firstName="Abhishek";
     const lastName="Agarwal";
     const middleName="Gopal";
     console.log(firstName.repeat(2));// "AbhishekAbhishek"
     console.log(lastName.repeat(3));//"AgarwalAgarwalAgarwal   "
     console.log(middleName.repeat(2));//"GopalGopal"
     ```
   - The repeat() method returns a new string with the specified number of copies of the string.
