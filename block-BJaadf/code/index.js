...
fruits.splice(0,0,'DragonFruit');
console.log(fruits);
// Log true or false based on the value at index 0 and 1 is 'Dragon Fruit' and 'Guava' or not
if(fruits[0]==='DragonFruit'&& fruits[1]==="Guava"){
    console.log(true);
}
else{
    console.log(false);
...
let lowercaseFruits=fruit.map(fruit=>fruit.toLowerCase());


// Convert all fruits name into uppercase and store in new array named uppercaseFruits
let uppercaseFruits=fruit.map(fruit=>fruit.toUpperCase());
